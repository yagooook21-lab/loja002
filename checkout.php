...
<body>
    ...
    <div class="container">
        <div class="cart-content">
            ...
            $dia_semana_nome = $dias_semana_pt[(int)$data_entrega->format('N')];
            $dia_numero = $data_entrega->format('j');
            $mes_nome = $meses_pt[(int)$data_entrega->format('n')];
            ?>

            <div class="card" style="margin-top: 12px;">
                <div style="display: flex; align-items: center; gap: 8px; padding-bottom: 12px; border-bottom: 1px solid #eee;">
                    <span style="font-size: 16px; font-weight: 600; color: #333;">Envio</span>
                    <span style="display: inline-flex; align-items: center; gap: 3px; color: #00a650; font-weight: 700; font-size: 14px;">
                        <i class="fa-solid fa-bolt" style="font-size: 12px;"></i> FULL
                    </span>
                </div>
                <div style="display: flex; align-items: center; gap: 10px; padding-top: 14px;">
                    <span style="width: 20px; height: 20px; border-radius: 50%; border: 2px solid #3483fa; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                        <span style="width: 10px; height: 10px; border-radius: 50%; background: #3483fa;"></span>
                    </span>
                    <span style="font-size: 15px; color: #333;">
                        Chegará até <strong><?php echo $dia_semana_nome; ?> <?php echo $dia_numero; ?> de <?php echo $mes_nome; ?></strong>
                    </span>
                    <span style="color: #00a650; font-weight: 600; font-size: 15px; margin-left: auto;">Grátis</span>
                </div>
            </div>
        </div>
