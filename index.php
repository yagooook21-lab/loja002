...
$path = basename(trim($request_uri, '/'));
$valid_routes = ['catalogo', 'politica-de-privacidade', 'termos-de-uso', 'trocas-e-devolucoes', 'checkout', 'payment', 'rastreio', 'success'];
if (in_array($path, $valid_routes) && file_exists($path . '.php')) {
    require($path . '.php');
    exit();
}
